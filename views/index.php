            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-events" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-events">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-events">
                      ...
                      <li class="nav-item"><a class="nav-link" href="unanswered">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Undefined Response</span>
                          </div>
                        </a>
                      </li>
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="./log" role="button" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">History Chatbot</span></span>
                    </div>
                  </a>
                </div>
                <!-- parent pages-->
                ...
                <!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#report_chatbot" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="report_chatbot">
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="bookmark"></span></span><span class="nav-link-text">Report Chatbot</span>
                    </div>
                  </a>
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="report_chatbot">
              ...
              <li class="nav-item">
                <!-- label-->
                <p class="navbar-vertical-label">Customer Service
                </p>
                <hr class="navbar-vertical-line" />
                <!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="./livechat" role="button" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Livechat</span></span>
                    </div>
                  </a>
                </div>
                <!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="./history_chat" role="button" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">History Livechat</span></span>
                    </div>
                  </a>
                </div>
                <!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#report_livechat" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="report_livechat">
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="bookmark"></span></span><span class="nav-link-text">Report Livechat</span>
                    </div>
                  </a>
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="report_livechat">
                      <li class="collapsed-nav-item-title d-none">Report Livechat
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./lc_agent">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Livechat Handling</span>
                          </div>
                        </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./lc_channel">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Livechat Channel</span>
                          </div>
                        </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./lc_jam">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Report Per Hours</span>
                          </div>
                        </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./lc_tag">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Tag</span>
                          </div>
                        </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./lc_rating">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Rating</span>
                          </div>
                        </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./lc_avg_respon">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Response Speed</span>
                          </div>
                        </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./lc_avg_speed">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Completion Speed</span>
                          </div>
                        </a>
                      </li>
                    </ul>
                ...
                <!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#operator" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="operator">
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="bookmark"></span></span><span class="nav-link-text">Operator</span>
                    </div>
                  </a>
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="operator">
                      <li class="collapsed-nav-item-title d-none">Operator
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./operator">
                          <div class="d-flex align-items-center"><span class="nav-link-text">List</span>
                          </div>
                        </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./absen">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Attendance</span>
                          </div>
                        </a>
                      </li>
                    </ul>
              ...
              <li class="nav-item">
                <!-- label-->
                <p class="navbar-vertical-label">Broadcast
                </p>
                <hr class="navbar-vertical-line" />
                <!-- parent pages-->
                <div class="nav-item-wrapper">
                  <a class="nav-link dropdown-indicator label-1" href="#broadcast" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="broadcast">
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="bookmark"></span></span><span class="nav-link-text">Broadcast</span>
                    </div>
                  </a>
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="broadcast">
                      <li class="collapsed-nav-item-title d-none">Broadcast
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./template_broadcast">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Template Whatsapp Official</span>
                          </div>
                        </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./kirim_broadcast">
                          <div class="d-flex align-items-center"><span class="nav-link-text">BC Whatsapp Official</span>
                          </div>
                        </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="./laporan_broadcast">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Laporan BC Whatsapp</span>
                        </div>
                        </a>
                      </li>
                    </ul>
